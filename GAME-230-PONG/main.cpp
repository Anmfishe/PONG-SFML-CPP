...
SoundBuffer buf1, buf2, scorebuf;
Sound ping1, ping2, score;
char score_one;
char score_two;
Font font;
...
int main()
{
	...
	srand(time(NULL));
	window.create(VideoMode(800, 600), "Ponggggg");
	...
	playAgainMessage.setColor(Color::Green);
	playAgainMessage.setPosition(0, 0);

	buf1.loadFromFile("../Assets/Paddlehit.wav");
	ping1.setBuffer(buf1);

	buf2.loadFromFile("../Assets/Wallhit.wav");
	ping2.setBuffer(buf2);

	scorebuf.loadFromFile("../Assets/Scored.wav");
	score.setBuffer(scorebuf);

	background.setSize(Vector2f(800, 600));
	backTex.loadFromFile("../Assets/1.jpg");
